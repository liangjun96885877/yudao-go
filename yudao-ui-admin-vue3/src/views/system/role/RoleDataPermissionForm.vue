...
// 防提权：非超管隐藏「全部数据」(scope=1) 选项
const isSuperAdmin = ref(false)
const scopeOptions = computed(() => {
  const all = getIntDictOptions(DICT_TYPE.SYSTEM_DATA_SCOPE)
  return isSuperAdmin.value ? all : all.filter((o: any) => Number(o.value) !== 1)
})
