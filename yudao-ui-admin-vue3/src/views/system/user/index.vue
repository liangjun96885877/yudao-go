          ...
          <el-table-column label="操作" align="center" width="220">
            <template #default="scope">
              <div class="flex items-center justify-center">
                ...
                <el-button type="primary" link @click="openChatter(scope.row)">
...
const chatterRef = ref() // 业务动态抽屉

/** 打开某用户的业务动态（Chatter） */
const openChatter = (row: any) => {
  chatterRef.value.open('system_user', row.id, row.nickname)
}
