...
const remainingRouter: AppRouteRecordRaw[] = [
  ...
  // 自用 ERP(myerp)详情 / 新建路由
  // 列表路由由 system_menu 表登记,这里只挂"详情/新建"类隐藏路由,不在侧边栏冒出。
  // activeMenu 让面包屑高亮回列表菜单。
  {
    path: '/myerp',
    component: Layout,
    name: 'MyErpDetailParent',
    meta: { hidden: true },
    children: [
      {
        path: 'category/create',
        component: () => import('@/views/myerp/category/detail.vue'),
        name: 'MyErpCategoryCreate',
        meta: {
          title: '新建分类',
          noCache: true,
          hidden: true,
          canTo: true,
          activeMenu: '/myerp/category'
        }
      },
      {
        path: 'category/:id(\\d+)',
        component: () => import('@/views/myerp/category/detail.vue'),
        name: 'MyErpCategoryDetail',
        meta: {
          title: '分类详情',
          noCache: true,
          hidden: true,
      ...
      },
      {
        ...
        component: () => import('@/views/myerp/attribute/detail.vue'),
        name: 'MyErpAttributeCreate',
        meta: {
          title: '新建属性',
          noCache: true,
          hidden: true,
          canTo: true,
          activeMenu: '/myerp/attribute'
        }
      },
      {
        path: 'attribute/:id(\\d+)',
        component: () => import('@/views/myerp/attribute/detail.vue'),
        name: 'MyErpAttributeDetail',
        meta: {
          title: '属性详情',
          noCache: true,
          hidden: true,
      ...
      {
        path: 'product/create',
        component: () => import('@/views/myerp/product/detail.vue'),
        name: 'MyErpProductCreate',
        meta: {
          title: '新建产品',
          noCache: true,
          hidden: true,
          canTo: true,
          activeMenu: '/myerp/product'
        }
      },
      {
        path: 'product/:id(\\d+)',
        component: () => import('@/views/myerp/product/detail.vue'),
        name: 'MyErpProductDetail',
        meta: {
          title: '产品详情',
          noCache: true,
          hidden: true,
      ...
      {
        path: 'uom/create',
        component: () => import('@/views/myerp/uom/detail.vue'),
        name: 'MyErpUomCreate',
        meta: {
          title: '新建单位',
          noCache: true,
      ...
      {
        path: 'batch/create',
        component: () => import('@/views/myerp/batch/detail.vue'),
        name: 'MyErpBatchCreate',
        meta: {
          title: '新建批次',
          noCache: true,
          hidden: true,
          canTo: true,
          activeMenu: '/myerp/batch'
        }
      },
      {
        path: 'batch/:id(\\d+)',
        component: () => import('@/views/myerp/batch/detail.vue'),
        name: 'MyErpBatchDetail',
        meta: {
          title: '批次详情',
          noCache: true,
          hidden: true,
      ...
      },
      {
        ...
        component: () => import('@/views/myerp/template/detail.vue'),
        name: 'MyErpTemplateCreate',
        meta: {
          title: '新建模板',
          noCache: true,
          hidden: true,
          canTo: true,
          activeMenu: '/myerp/template'
        }
      },
      {
        path: 'template/:id(\\d+)',
        component: () => import('@/views/myerp/template/detail.vue'),
        name: 'MyErpTemplateDetail',
        meta: {
          title: '模板详情',
          noCache: true,
          hidden: true,
